...
use App\Http\Controllers\Api\V1\PledgeController;
...
Route::prefix('v1')->group(function () {
    ...
    // ─── Pledge Day endpoints (public – no device auth required) ─
    Route::post('/pledges', [PledgeController::class, 'store']);
    Route::post('/pledges/batch', [PledgeController::class, 'batchSync']);
